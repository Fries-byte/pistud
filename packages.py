...
if name == "versions":
  if version == 9:
    ...
    exec(urllib.request.urlopen("https://raw.githubusercontent.com/PiStud-Lang/PiStud/refs/heads/main/src/ps_ver4.py").read().decode())
  elif version == 3:
    exec(urllib.request.urlopen("https://raw.githubusercontent.com/PiStud-Lang/PiStud/refs/heads/main/src/ps_ver3.py").read().decode())
  elif version == 2:
    exec(urllib.request.urlopen("https://raw.githubusercontent.com/PiStud-Lang/PiStud/refs/heads/main/src/ps_ver2.py").read().decode())
  elif version == 1:
